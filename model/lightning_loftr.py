...
from model.utils.comm import gather
from model.utils.misc import lower_config, flattenList
from model.utils.profiler import PassThroughProfiler
    ...
    def __init__(self, config, pretrained_ckpt=None, profiler=None, dump_dir=None):
        ...
        if pretrained_ckpt:
            self.matcher.load_state_dict(
                {k.replace('matcher.', ''): v for k, v in torch.load(pretrained_ckpt, map_location='cpu').items()})
