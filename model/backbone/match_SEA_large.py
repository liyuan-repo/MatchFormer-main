...
class Matchformer_SEA_large(nn.Module):
    def __init__(self, img_size=224, in_chans=1, embed_dims=[128, 192, 256, 512], num_heads=[1, 2, 4, 8],
                 sr_ratios=[4, 2, 2, 1],
                 stage1_cross=[False, False, True], stage2_cross=[False, False, True], stage3_cross=[False, True, True],
        ...
        self.AttentionBlock1 = AttentionBlock(img_size=img_size // 2, patch_size=7, num_heads=num_heads[0],
                                              ...
                                              embed_dims=embed_dims[0], stride=2, sr_ratios=sr_ratios[0], depths=3,
                                              cross=stage1_cross)
